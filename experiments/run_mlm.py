...
def main():
    ...
    if data_args.counterfactual_augmentation is not None:
        ...
        elif 'wiki-ca_sample_10.txt' in data_args.train_file:
            bias_attribute_words= _create_bias_attribute_words(f"{data_args.persistent_dir}/data/bias_attribute_words_ca.json", bias_type=data_args.counterfactual_augmentation)
        else:
