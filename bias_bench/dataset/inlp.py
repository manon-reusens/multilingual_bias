...
def load_inlp_data(persistent_dir, bias_type, seed=0, lang_debias='en'):
    ...
    if bias_type == "gender":
        data = _load_gender_data(persistent_dir,lang_debias)
    elif bias_type == "race":
        data = _load_race_data(persistent_dir,lang_debias)
    else:
        data = _load_religion_data(persistent_dir,lang_debias)
    return data


def _load_gender_data(persistent_dir,lang_debias):
    ...
    if lang_debias=='en':
        ...
        with open(f"{persistent_dir}/data/bias_attribute_words_pl.json", "r") as f:
            attribute_words = json.load(f)["gender"]
        with open(f"{persistent_dir}/data/text/wiki-pl_sample_2.5.txt", "r") as f:
            lines = f.readlines()
        random.shuffle(lines)
    elif lang_debias=='ru':
        with open(f"{persistent_dir}/data/bias_attribute_words_ru.json", "r") as f:
            attribute_words = json.load(f)["gender"]
        with open(f"{persistent_dir}/data/text/wiki-ru_sample_2.5.txt", "r") as f:
            lines = f.readlines()
        random.shuffle(lines)
    elif lang_debias=='ca':
        with open(f"{persistent_dir}/data/bias_attribute_words_ca.json", "r") as f:
            attribute_words = json.load(f)["gender"]
        with open(f"{persistent_dir}/data/text/wiki-ca_sample_2.5.txt", "r") as f:
            lines = f.readlines()
        random.shuffle(lines)
...
def _load_race_data(persistent_dir,lang_debias):
    # Load the bias attribute words.
    if lang_debias=='en':
        with open(f"{persistent_dir}/data/bias_attribute_words.json", "r") as f:
...
def _load_religion_data(persistent_dir,lang_debias):
    # Load the bias attribute words.
    if lang_debias=='en':
        with open(f"{persistent_dir}/data/bias_attribute_words.json", "r") as f:
